...
export const SyncPage = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-y-auto p-6 sm:p-8 select-none">
      {/* Header Banner */}
      <div className="relative rounded-3xl bg-gradient-to-r from-indigo-950/40 via-purple-950/20 to-black/60 p-6 sm:p-8 border border-indigo-500/10 mb-8 shrink-0 shadow-lg">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-indigo-400">Device Integration</p>
            <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">Devices & Background Sync</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="flex flex-col p-6 rounded-3xl bg-[#18181b] border border-white/5 shadow-xl">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">Android Phone Auto-Backup</h3>
                <p className="text-xs text-zinc-400">Background Camera & DCIM Sync</p>
              </div>
            </div>
          ...
          {/* Stats Box */}
          <div className="grid grid-cols-2 gap-4 p-4 rounded-2xl bg-[#121214] border border-white/5 mb-6">
            <div>
              <p className="text-xs text-zinc-400">Backed Up Photos & Videos</p>
        ...
        <div className="flex flex-col p-6 rounded-3xl bg-[#18181b] border border-white/5 shadow-xl">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">Windows 11 Synced Folder</h3>
                <p className="text-xs text-zinc-400">Two-Way Designated Folder Sync</p>
              </div>
            </div>
          ...
          <div className="bg-[#121214] p-4 rounded-2xl border border-white/5 mb-6">
            ...
            <code className="text-xs font-mono text-indigo-300 block bg-black/40 p-2.5 rounded-lg">
          ...
          <div className="flex flex-col gap-2.5 text-xs text-zinc-300">
            <div className="flex items-center gap-2 text-emerald-400 font-semibold">
              <CheckCircle2 className="w-4 h-4" /> Two-Way Realtime Chokidar File Watcher
            </div>
            <div className="flex items-center gap-2 text-emerald-400 font-semibold">
              <CheckCircle2 className="w-4 h-4" /> SHA256 Diff & Conflict Resolution
            </div>
            <div className="flex items-center gap-2 text-emerald-400 font-semibold">
              <CheckCircle2 className="w-4 h-4" /> Zero-footprint borrowed machine safety
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-[#18181b] border border-white/5 shadow-xl">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 rounded-xl bg-teal-500/10 flex items-center justify-center text-teal-400">
            <ShieldCheck className="w-6 h-6" />
          </div>
          <div>
            <h3 className="text-lg font-bold text-white">Tailscale VPN Remote Access Setup</h3>
            <p className="text-xs text-zinc-400">Secure, encrypted zero-config connection from anywhere</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          <div className="p-4 rounded-2xl bg-[#121214] border border-white/5">
            <h4 className="font-bold text-white mb-2">1. On Arch Linux Server</h4>
            <pre className="font-mono text-zinc-400 bg-black/40 p-2.5 rounded-lg mb-2">
              sudo pacman -S tailscale{"\n"}
              sudo systemctl enable --now tailscaled{"\n"}
              sudo tailscale up
            </pre>
            <p className="text-zinc-400">Note down the <code>100.x.y.z</code> IP assigned to your server.</p>
          </div>

          <div className="p-4 rounded-2xl bg-[#121214] border border-white/5">
            <h4 className="font-bold text-white mb-2">2. On Windows 11 Laptop</h4>
            <p className="text-zinc-300 mb-3">Install Tailscale for Windows and sign in with the same account.</p>
          ...
          <div className="p-4 rounded-2xl bg-[#121214] border border-white/5">
            ...
            <p className="text-zinc-300 mb-3">Install Tailscale from Google Play Store or F-Droid and turn it ON.</p>
            <p className="text-zinc-400">
