...
export const MusicPlayerBar = () => {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 h-20 bg-[#121214] border-t border-white/10 px-4 sm:px-6 flex items-center justify-between z-30 select-none">
